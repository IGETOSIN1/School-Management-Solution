<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report-Internal1.aspx.cs" Inherits="WEB_SCONET_MANAGEMENT.Report_Internal1" %>
...
<body style=" background-color: midnightblue;">
    ...
    <asp:textbox ID="session_query" runat="server" ForeColor="Black" 
        ...
        ForeColor="Black" Visible="False" 
            ontextchanged="school_campus_query_TextChanged"></asp:textbox>
    ...
    <asp:Label ID="Label1" runat="server" Text="Session" class="lab"></asp:Label>
                 <asp:DropDownList ID="session1" runat="server" 
            style=" width: 190px; height: 21px; margin-left: 6px; margin-right: 6px;"  class="ddp_long"
                ForeColor="Firebrick" 
            onselectedindexchanged="session1_SelectedIndexChanged">
            ...
            <label class="lab" style=" margin-left: 6px;" > Term</label>
                 <asp:DropDownList ID="term1" runat="server" class="ddp_long" 
                    style=" margin-left: 6px;" ForeColor="Firebrick" 
            onselectedindexchanged="term1_SelectedIndexChanged"> 
                     <asp:ListItem>First</asp:ListItem>
                     <asp:ListItem>Second</asp:ListItem>
                     <asp:ListItem>Third</asp:ListItem>
                 </asp:DropDownList> 

                <asp:Label ID="Label4" runat="server" Text="Class" class="lab"></asp:Label>
                ...
                ForeColor="Firebrick" > </asp:DropDownList>
        ...
        <asp:CheckBox ID="chk_terminal" runat="server" Text="Terminal Result" 
            ...
            Checked="True"/>
                ...
                <br/><asp:Label ID="Label5" runat="server" Text="Students' Name" class="lab"></asp:Label>
                 <asp:DropDownList ID="student_name_query" runat="server" 
                AutoPostBack="True" class="ddp_long"
                style=" width: 250px; height: 22px; margin-left: 6px; margin-right: 6px;" 
                ForeColor="Firebrick" > </asp:DropDownList>  
            ...
            Height="28px" Width="120px" onclick="Button3_Click" />
    ...
    <p style=" float: left; margin-top: 1px;  background-color: orange;">
        <asp:Image ID="Image_logo" runat="server" style=" width: 140px; border: 2px solid deeppink; margin-left: 1px; height: 115px; background-color: ;" />
   ...
   <!-- <label >EMAIL: sunshineinternational@yahoo.com || WEBSITE: www.sunshine.com.ng</label><br/>-->
    <asp:Label ID="phone" runat="server" Text="Label" style=" font-family: Cursive; font-size: 17px; color: orangered; "></asp:Label>
        ...
        <!---################################# FILE COPY ########################################3333333-->
       <!-- <img src="images/filecopy1.png" alt="File Copy" style=" z-index: -1; margin-left: 480px; margin-top: 150px;"/>-->
        <!---################################# FILE COPY ########################################3333333-->
    ...
    <hr style=" width: 100%; border: 2px solid black; float: left; margin-top: -13px; margin-bottom: -35px;"/>
      ...
      <label class="lb" style=" margin-left: 0px;">STUDENT ID: </label> 
        ...
        <div style="display:flex;position:relative; margin-bottom:0px;">
            <asp:GridView ID="GridView1" runat="server" BorderStyle="Double" 
                EmptyDataText="Your result had not been uploaded. Try again later ..." 
                 Font-Names="Times New Roman" Font-Size="13pt" 
                style="float: left; margin-left: 5px; text-align: center; font-family: Times New Roman; font-weight: bold; font-size: 13px;flex:1; height:500px; width: 940px;">
       ...
       <!-- <p style="transform: rotate(270deg); transform-origin: left top 0; float: left; margin-top:380px;flex:1; "><asp:Label ID="name_school_side" runat="server" Text="Label" style=" font-family: Cursive; font-size: 17px;  color: midnightblue; "></asp:Label> </p>-->
            ...
            <div runat="server" id="div_first_second_mid" style=" font-family: Times New Roman; font-size: 18px; position:relative; margin-top:-33px;"> 
           ...
           <asp:Label ID="cummulative_remark1" runat="server" Text="Label"></asp:Label>
            ...
            <div runat="server" id="div_third_only" style=" font-family: Times New Roman; font-size: 14px; margin-top:0px;"> 
           ...
           <font> Cummulative (%)  </font>       <asp:TextBox ID="aggregate2" runat="server" 
             ...
             <p style=" float: right;font-weight: bold;">
              <font>Session Average(%)</font>  <asp:TextBox ID="session_average2" runat="server" 
                     style=" margin-left: 27px; border: 3px solid black; width: 80px; text-align: center; height: 19px;"></asp:TextBox><br/>
           <font>Cumm. Grade</font>    <asp:TextBox ID="cumm_grade2" runat="server" 
                     style=" margin-left: 60px;border: 3px solid black; width: 80px; text-align: center; height: 19px;"></asp:TextBox><br/>
           <font>Cumm. Remark</font>       <asp:TextBox ID="cumm_remark2" runat="server" 
             ...
             <p runat="server" id="vgv" style=" margin-left: 320px;font-weight: bold;">
             <br/>
